...
class Post extends Model
{
    ...
    public function seoOptions(): array
    {
        return [
            ...
            'meta_description' => $this->meta_description ?: $this->excerpt ?: Str::limit(strip_tags($this->content), 150),
            'meta_keywords' => $this->meta_keywords,
            'canonical_url' => $this->canonical_url,
            'og_title' => $this->og_title ?: $this->meta_title ?: $this->title,
            'og_description' => $this->og_description ?: $this->meta_description ?: $this->excerpt ?: Str::limit(strip_tags($this->content), 150),
